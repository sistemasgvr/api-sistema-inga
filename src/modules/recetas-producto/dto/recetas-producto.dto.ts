...
export class GuardarRecetaInsumoDto extends AuditoriaDto {
  @ApiProperty({ description: 'ID del producto insumo (debe ser procesado u otro permitido)', example: 5 })
  @IsInt()
  @IsNotEmpty()
  id_producto_insumo!: number;

  @ApiProperty({ description: 'Cantidad necesaria', example: 150.00 })
  @IsNumber()
  @IsNotEmpty()
  cantidad!: number;

  @ApiProperty({ description: 'ID de la unidad de medida del insumo', example: 3 })
  @IsInt()
  @IsNotEmpty()
  id_unidad_medida!: number;

  @ApiPropertyOptional({ description: 'Porcentaje de merma estimado', default: 0 })
  @IsOptional()
  @IsNumber()
  porcentaje_merma?: number;

  @ApiPropertyOptional({ description: 'Si el insumo es opcional', default: false })
  @IsOptional()
  @IsBoolean()
  es_opcional?: boolean;

  @ApiPropertyOptional({ description: 'Grupo de sustitución para alternativas (ej: pescados)' })
  @IsOptional()
  @IsInt()
